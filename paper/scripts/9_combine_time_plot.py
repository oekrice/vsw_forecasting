    ...
    for b in bs:
        ...
        for i in [7]:
            ...
            if scale_source == "WSA":
                ...
                print('Optimum factor', optimum_factor)
            ...
            axs[0].set_xticks([])
            axs[1].plot(crot_numbers[start_plot_cut:-end_plot_cut], all_rs[start_plot_cut:-end_plot_cut], label = 'Optimised and Scaled Prediction', linewidth=1.0)
        ...
        plt.savefig(f'./paper/plots/9_combine_time_plot.pdf')
        plt.show()
        plt.close()
