...
if hamilton_advance:
    inputrun = "fcast-repl8_u20231224.12"
    os.system("rsync -av bmjg46@hamilton8:/nobackup/bmjg46/"+inputrun+" /Volumes/bmjg46/prs/dumfric/")
    inputpath = "/Volumes/bmjg46/prs/dumfric/"+inputrun+"/"
else:
    inputpath = "/Volumes/bmjg46/prs/dumfric/fcast-repl8_s20230101.12/"

# Desired finish time:
dtime_input = datetime.datetime.strptime(inputpath[-12:-1],"%Y%m%d.%H")
if hamilton_advance:
    dtime_f = dtime_input + datetime.timedelta(days=7)
...
if hamilton_advance:
    os.system("rsync -av "+outputpath[:-1]+" bmjg46@hamilton8:/nobackup/bmjg46/")
    os.system("scp user.nml bmjg46@hamilton8:~/dumfric-fcast/")
